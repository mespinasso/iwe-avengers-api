...
public class TokenGenerator {
	...
	public String getToken() {
		...
		final String clientId = "3ai3u9vhdh3dvbjjeksss0pee3";
		final String userPoolId = "us-east-1_KnCAHO2su";
		...
		initiateAuthRequest.addAuthParametersEntry("USERNAME", "mespinasso");
